...
<head>
  ...
  <% } %>
  <meta charset="utf-8">
  <%- include('${CE_TEMPLATE_NAME.PDF_MERMAID_SCRIPT}', { versions, option, metadata }); %>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-4bw+/aepP/YC94hEpVNVgiZdgIC5+VKNBQNGCHeKRQN+PtmoHDEXuppvnDJzQIu9" crossorigin="anonymous">
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-HwwvtgBNo3bZJJLYd8oVXjrBZt8cqVSpeBNS5n7C8IVInixGAoxmnlMuBnhbgrkm" crossorigin="anonymous"></script>
  <%- include('${CE_TEMPLATE_NAME.PDF_STYLE}', { versions, option, metadata }); %>
</head>
...
<body class="bg-body-tertiary">
  ...
  <% versions.filter((version) => version.latest).forEach((version) => { %>
    ...
    <section id="content">
      ...
      <%- include('${CE_TEMPLATE_NAME.PDF_DOCUMENT_TOC}', { entities: version.entities, option, metadata }); %>
    </section>
    ...
    <section id="content">
      ...
      <%- include('${CE_TEMPLATE_NAME.PDF_TABLE}', { entities: version.entities, option, metadata }); %>
    </section>
    <% } %>
